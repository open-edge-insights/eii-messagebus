...
> the `CMAKE_INSTALL_PREFIX` flag. If different installation path is given via `CMAKE_INSTALL_PREFIX`, then
> `$LD_LIBRARY_PATH` should be appended by $CMAKE_INSTALL_PREFIX/lib.
